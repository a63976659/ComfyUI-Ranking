...
export function createCreatorCard(creatorData, currentUser = null) {
    ...
    detailView.innerHTML = `
        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 15px;">
            <img src="${creatorData.avatar}" style="width: 50px; height: 50px; border-radius: 50%; border: 2px solid #555; object-fit: cover;">
            <div style="flex: 1;">
    ...
    function renderTrendChart() {
        ...
        loadECharts().then(echarts => {
            ...
            chartInstance.setOption({
                ...
                xAxis: { type: 'category', data: ['1月', '2月', '3月', '4月', '5月', '6月'], axisLabel: { color: '#888', fontSize: 10 }, axisLine: { lineStyle: { color: '#444' } } },
