    ...
    return `
        ...
        <div style="display: flex; gap: 10px; margin-bottom: 5px;">
            <div style="flex: 1;">
                ...
                <select id="pub-type" style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #fff; border-radius: 4px;">
            ...
            <div id="box-recommend-type" style="display: none; flex: 1;">
                ...
                <select id="pub-recommend-type" style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #fff; border-radius: 4px;">
            ...
            <div style="flex: 2;">
                ...
                <input type="text" id="pub-title" placeholder="${t('publish.name_placeholder')}" required style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #fff; border-radius: 4px; box-sizing: border-box;">
            </div>
        </div>

        <div style="margin-bottom: 5px;">
            <label style="display: block; margin-bottom: 5px;">${t('publish.short_desc')} <span style="color: #F44336;">*</span></label>
            <input type="text" id="pub-short" placeholder="${t('publish.short_desc_placeholder')}" maxlength="50" required style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #fff; border-radius: 4px; box-sizing: border-box;">
        </div>

        <div style="display: flex; gap: 10px; margin-bottom: 5px; background: var(--comfy-input-bg); padding: 10px; border-radius: 4px; border: 1px dashed #555;">
            <div style="flex: 1;" id="box-resource-select">
                ...
                <select id="pub-resource-type" style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #fff; border-radius: 4px;">
            ...
            <div style="flex: 2;" id="box-link">
                ...
                <input type="text" id="pub-link" placeholder="${t('publish.source_url_placeholder')}" style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #fff; border-radius: 4px; box-sizing: border-box;">
            </div>
            ...
            <div style="flex: 2; display: none;" id="box-netdisk">
                ...
                <input type="text" id="pub-netdisk-link" placeholder="${t('publish.netdisk_placeholder')}" style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #fff; border-radius: 4px; box-sizing: border-box;">
            </div>
        </div>

        <div id="netdisk-password-settings" style="margin-bottom: 5px; background: var(--comfy-input-bg); padding: 10px; border-radius: 4px; border: 1px dashed #555; display: none;">
        ...
        <div id="private-repo-settings" style="margin-bottom: 5px; background: var(--comfy-input-bg); padding: 10px; border-radius: 4px; border: 1px dashed #555; display: none;">
        ...
        <div id="box-cover" style="margin-bottom: 5px; background: var(--comfy-input-bg); padding: 10px; border-radius: 4px; border: 1px dashed #555;">
        ...
        <div id="box-price" style="display: flex; gap: 10px; margin-bottom: 5px;">
            <div style="flex: 1; display: flex; flex-direction: column; justify-content: center;">
                ...
                <input type="number" id="pub-price" value="0" min="0" style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #FF9800; font-weight: bold; border-radius: 4px; box-sizing: border-box;">
                <!-- 🔄 P7后悔模式：价格延迟生效提示 -->
        ...
        <div style="margin-bottom: 10px;">
            ...
            <textarea id="pub-full" rows="36" placeholder="${t('publish.full_desc_placeholder')}" style="width: 100%; padding: 8px; background: var(--comfy-input-bg); border: 1px solid #555; color: #fff; border-radius: 4px; resize: vertical; box-sizing: border-box;"></textarea>
        </div>
