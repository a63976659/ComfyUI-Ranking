...
export function generatePublishHTML(isEditMode, viewTitle, submitBtnText, hasExistingToken, editItemData, t) {
    ...
    return `
        <style>.form-input{width:100%;padding:8px;background:var(--comfy-input-bg);border:1px solid #555;color:#fff;border-radius:4px;box-sizing:border-box;}</style>
        ...
        <div style="display: flex; gap: 10px; margin-bottom: 5px;">
            ...
            <div style="flex: 2;">
                ...
                <input type="text" id="pub-title" placeholder="${t('publish.name_placeholder')}" required class="form-input">
            </div>
        </div>

        <div style="margin-bottom: 5px;">
            <label style="display: block; margin-bottom: 5px;">${t('publish.short_desc')} <span style="color: #F44336;">*</span></label>
            <input type="text" id="pub-short" placeholder="${t('publish.short_desc_placeholder')}" maxlength="50" required class="form-input">
        </div>
        ...
        <div style="display: flex; gap: 10px; margin-bottom: 5px; background: var(--comfy-input-bg); padding: 10px; border-radius: 4px; border: 1px dashed #555;">
            <div style="flex: 1;" id="box-resource-select">
                ...
                <select id="pub-resource-type" class="form-input">
            ...
            <div style="flex: 2;" id="box-link">
                ...
                <input type="text" id="pub-link" placeholder="${t('publish.source_url_placeholder')}" class="form-input">
            </div>
            ...
            <div style="flex: 2; display: none;" id="box-netdisk">
                ...
                <input type="text" id="pub-netdisk-link" placeholder="${t('publish.netdisk_placeholder')}" class="form-input">
            </div>
        </div>
        ...
        <div id="netdisk-password-settings" style="margin-bottom: 5px; background: var(--comfy-input-bg); padding: 10px; border-radius: 4px; border: 1px dashed #555; display: none;">
            <div style="display: flex; gap: 10px; align-items: flex-start;">
                <div style="flex: 1;">
                    ...
                    <input type="text" id="pub-netdisk-password" placeholder="${t('publish.netdisk_password_placeholder')}" maxlength="20" class="form-input" style="background: #222;">
                </div>
        ...
        <div id="private-repo-settings" style="margin-bottom: 5px; background: var(--comfy-input-bg); padding: 10px; border-radius: 4px; border: 1px dashed #555; display: none;">
            ...
            <div id="github-token-container" style="display: ${hasExistingToken ? 'block' : 'none'}; margin-top: 10px; padding: 12px; background: rgba(33, 150, 243, 0.1); border: 1px dashed #2196F3; border-radius: 6px;">
                ...
                <input type="password" id="pub-github-token" value="${isEditMode ? (safeData.github_token || '') : ''}" placeholder="${hasExistingToken && !safeData.github_token ? t('publish.token_keep_hint') : t('publish.token_placeholder')}" class="form-input" style="background: #222;">
            </div>
        </div>
        ...
        <div id="box-price" style="display: flex; gap: 10px; margin-bottom: 5px;">
            <div style="flex: 1; display: flex; flex-direction: column; justify-content: center;">
                ...
                <input type="number" id="pub-price" value="0" min="0" class="form-input" style="color: #FF9800; font-weight: bold;">
                <!-- 🔄 P7后悔模式：价格延迟生效提示 -->
        ...
        <div style="margin-bottom: 10px;">
            ...
            <textarea id="pub-full" rows="36" placeholder="${t('publish.full_desc_placeholder')}" class="form-input" style="resize: vertical;"></textarea>
        </div>
